...
The fastest way to try Wireweave is through the [Playground](https://playground.wireweave.org). No installation required - just start writing code!
...
1. Get an API key from the [Dashboard](https://dashboard.wireweave.org)
